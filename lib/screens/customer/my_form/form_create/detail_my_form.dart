...
import 'package:swp_project_web/screens/staff/manage_form/bloc/form_state.dart';
...
class DetailMyForm extends StatefulWidget {
  final FormsModel? formModel;
  const DetailMyForm({super.key, this.formModel});

  @override
  State<DetailMyForm> createState() => _DetailMyFormState();
}

class _DetailMyFormState extends State<DetailMyForm> {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const Spacer(),
                                    Text(
                                      FormatProvider().convertTypeProperty(
                                          formModel.propertyTypeId),
                                      style: const TextStyle(
                                        color: Colors.black,
                                        fontSize: 14,
                                      ),
