...
class PostModel {
  ...
  factory PostModel.fromMap(Map<String, dynamic> map) {
    return PostModel(
      ...
      propertyStreet: map['propertyStreet'] != null ? map['propertyStreet'] as String : null,
      propertyWard: map['propertyWard'] != null ? map['propertyWard'] as String : null,
      propertyDistrict: map['propertyDistrict'] != null ? map['propertyDistrict'] as String : null,
      propertyCity: map['propertyCity'] != null ? map['propertyCity'] as String : null,
      propertyArea: map['propertyArea'] != null ? map['propertyArea'] as double : null,
      propertyRevervePrice: map['propertyRevervePrice'] != null ? map['propertyRevervePrice'] as double : null,
      authorId: map['authorId'] != null ? map['authorId'] as int : null,
      author: map['author'] != null ? UserProfileModel.fromMap(map['author'] as Map<String,dynamic>) : null,
      approverId: map['approverId'] != null ? map['approverId'] as int : null,
      approver: map['approver'] != null ? UserProfileModel.fromMap(map['approver'] as Map<String,dynamic>) : null,
      propertyTypeId: map['propertyTypeId'] != null ? map['propertyTypeId'] as int : null,
      propertyType: map['propertyType'] != null ? PropertyTypeModel.fromMap(map['propertyType'] as Map<String,dynamic>) : null,
    );
  }
